...
- **데일리 브리핑 (Daily Briefing)**: 축적된 Radar 신호를 종합하여 Consulting–SI–MSP–Application ITO 밸류체인 재편, FDE 딜리버리, AI Pricing 전이, Agentic ITO 심층 분석 및 국내 MSP 관점 Top 3 Action을 요약 도출한다.
...
- `0 0 7 * * MON,WED` (매주 월·수 07:00): 데일리 브리핑 자동 생성 (`StrategyReportService.generateReport()`)
